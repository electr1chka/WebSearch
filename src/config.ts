...
const EnvSchema = z.object({
  ...
  BROWSER_HUMAN_IN_LOOP: z.coerce.boolean().default(false),
  BROWSER_SOLVE_TIMEOUT_MS: z.coerce.number().int().positive().default(120_000),
...
export function loadConfig(): AgentConfig {
  ...
  return {
    ...
    browserHumanInLoop: env.BROWSER_HUMAN_IN_LOOP,
    browserSolveTimeoutMs: env.BROWSER_SOLVE_TIMEOUT_MS,
    browserUserDataDir: emptyToUndefined(env.BROWSER_USER_DATA_DIR),
